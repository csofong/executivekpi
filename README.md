...
| **Executive Dashboard** | Scorecards + 4 live charts — nothing on this tab is a typed-in number |
...
All monetary values are illustrative, generated for this demonstration and clearly documented in the workbook — hardcoded inputs are shown in blue text throughout, every calculated cell is a black-text formula.
